...
#define UNIBOOT_SEG_NULL 0    /* Program header table entry unused */
#define UNIBOOT_SEG_LOAD 1    /* Loadable program segment */
#define UNIBOOT_SEG_DYNAMIC 2 /* Dynamic linking information */
#define UNIBOOT_SEG_INTERP 3  /* Program interpreter */
#define UNIBOOT_SEG_NOTE 4    /* Auxiliary information */
#define UNIBOOT_SEG_SHLIB 5   /* Reserved */
#define UNIBOOT_SEG_PHDR 6    /* Entry for header table itself */
#define UNIBOOT_SEG_TLS 7     /* Thread-local storage segment */
